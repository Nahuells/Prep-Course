...
function agregarMetodoCalculoDescuento(producto) {
  /*
 Agregar un propiedad (función) al objeto "producto" llamado "calcularPrecioDescuento"
 Este propiedad debe multiplicar el "precio" del "producto" ("producto.precio" o "producto[precio]") y 
 "porcentajeDeDescuento" para obtener el descuento
 El propiedad resta el descuento del precio y devuelve el precio con descuento
